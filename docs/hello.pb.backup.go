...
// *HelloResponse 实现proto.Message 接口
// Reset()、String()、ProtoMessage()
func (m *HelloResponse) Reset()         { *m = HelloResponse{} }
func (m *HelloResponse) String() string { return proto.CompactTextString(m) }
func (*HelloResponse) ProtoMessage()    {}

// HelloResponse 在描述文件信息中的位置
...
var E_Author = &proto.ExtensionDesc{
	...
	Field:         1000, // 扩展字段的标识ID
	Name:          "hello.author", // 扩展字段名称
	Tag:           "bytes,1000,opt,name=author", // 扩展字段tag
	Filename:      "protobuf_example/hello.proto", // 扩展字段所在文件
}
